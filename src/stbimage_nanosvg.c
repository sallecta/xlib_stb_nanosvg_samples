...
file set:
    stbimage_nanosvg.c              - main file
    stb_image.h                     - stb image single header library
    nanosvg.h                       - memononen/nanosvg Simple stupid SVG parser 
    nanosvgrast.h                   - memononen/nanosvg rasterizer

compile:
    gcc stbimage_nanosvg.c -o stbimage_nanosvg -L/usr/lib -L/usr/X11/lib -lX11 -lm
 */
...
#define stb_image_h "stb_image.h"
#define nanosvg_h "nanosvg.h"
#define nanosvgrast_h "nanosvgrast.h"
